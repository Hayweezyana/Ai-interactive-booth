...
exports.baseIdentityLock = baseIdentityLock;
exports.hugPrompt = hugPrompt;
exports.selfiePrompt = selfiePrompt;
exports.singlePersonPrompt = singlePersonPrompt;
function baseIdentityLock() {
    return `
...
function selfiePrompt(userPrompt) {
    return `
${baseIdentityLock()}
...
function singlePersonPrompt(userPrompt) {
    return `
${baseIdentityLock()}
